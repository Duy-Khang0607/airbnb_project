...
import { ACCESS_TOKEN, USER_LOGIN, setStore, setStoreJSON } from 'src/utils/setting';
...
const initialState = {
    userLogin: localStorage.getItem(USER_LOGIN) ? JSON.parse(localStorage.getItem(USER_LOGIN) as string) : null,
    stateLogin: "",
}
