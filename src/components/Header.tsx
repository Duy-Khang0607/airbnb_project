...
const Header = (props: Props) => {
  ...
  return (
    <>
      ...
      <Row className="bg-white py-5 mx-16 border-b-5 border-[#243c5a]  " style={{border: "20px", borderColor: "red"}} >
        <Col span={8} className=" ">
          <NavLink to={""}>
            <svg
              ...
              width="102"
              height="32"
              className="fill-current text-pink hidden xl:block "
            >
            ...
            <svg
              ...
              width="30"
              height="32"
              className="fill-current text-pink block xl:hidden"
            >
          ...
          <form action="/action_page.php">
            ...
            <button type="submit">
              <svg
                ...
                viewBox="0 0 24 24"
                stroke="currentColor"
                className=" p-2 ml-3 text-white rounded-full bg-primary"
              >
                <path
